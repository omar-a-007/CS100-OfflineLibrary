...
class LibraryManagement {
    ...
    public:
        ...
        void displayMedia(std::ostream& stream = std::cout)      { root->display(true, "", stream); }
        void displayCategories(std::ostream& stream = std::cout) { listCategories_recursive(root, "", stream); }
